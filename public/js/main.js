...
$('#typeahead').bind('typeahead:select', function(ev, suggestion) {
    ...
    window.location = path + '/search/?s=' + encodeURIComponent(suggestion.alias);
});
...
$('body').on('click', '.add-to-cart-link', function (e) {
    ...
    $.ajax({
        ...
        error: function () {
            alert('Ошибка! Попытка положить количество товара в корзину больше чем на остатке.');
        }
    });
...
$('.available select').on('change', function () {
    var modId = $(this).val(),
        color = $(this).find('option').filter(':selected').data('alias'),
