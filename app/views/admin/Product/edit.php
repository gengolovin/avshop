                ...
                <form action="<?=ADMIN;?>/product/edit" method="post" data-toggle="validator">
                    <div class="box-body">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" name="product_cod" class="form-control" id="description" placeholder="Код товара"  value="<?=h($product->product_cod); ?>" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="keywords" class="form-control" id="keywords" placeholder="Ключевые слова" value="<?=h($product->keywords);?>" required>
                            <div class="help-block with-errors"></div>
                            <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="description" class="form-control" id="description" placeholder="Описание" value="<?=h($product->description);?>" required>
                            <div class="help-block with-errors"></div>
                            <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        </div>
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" name="count" class="form-control" id="description" placeholder="Количество товара" pattern="^[1-9]+$" value="<?=$product->count;?>" data-error="Допускаются только цифры">
                            <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                            <div class="help-block with-errors"></div>
                        </div>
                        <div class="form-group has-feedback">
                            ...
                            <div class="col-md-4">
                                <div class="box box-danger box-solid file-upload">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="single">
                                            <img src="/images/prod/<?=$product->img;?>" alt="" style="max-height: 150px;cursor: pointer;" data-id="<?=$product->id;?>" data-src="<?=$product->img;?>" class="del-base"">
                                        </div>
                                    </div>
                                    <div class="overlay">
                                        ...
                                        <div class="multi">
                                            <?php if(!empty($gallery)): ?>
                                                <?php foreach($gallery as $item): ?>
                                                    <img src="/images/prod/<?=$item;?>" alt="" style="max-height: 150px; cursor: pointer;" data-id="<?=$product->id;?>" data-src="<?=$item;?>" class="del-item">
                                                <?php endforeach; ?>
                                            <?php endif; ?>
                                        </div>
                                    </div>
