                ...
                <form method="post" action="/user/signup" role="form" data-toggle="validator">
                    <div class="box-body">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <input class="form-control" name="telefon" id="telefon" type="telefon" value="<?= isset($_SESSION['form_data']['telefon']) ? $_SESSION['form_data']['telefon'] : '' ?>"  data-error=" Телефон должен включать не менее 10 символов" data-minlength="10" required>
                            <div class="help-block with-errors"></div>
                        </div>
                        <div class="form-group has-feedback">
