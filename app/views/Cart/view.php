                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-striped">
                                ...
                                <?php foreach($_SESSION['cart'] as $id => $item): ?>
                                    <tr>
                                        <td><a href="product/<?=$item['alias'] ?>"><img src="images/prod/<?= $item['img'] ?>" alt="<?=$item['title'] ?>"></a></td>
                                ...
                                <tr>
                                    <td>На сумму:</td>
                                    <td colspan="4" class="text-right cart-sum"><?= $_SESSION['cart.currency']['symbol_left'] . round($_SESSION['cart.sum'],2) . " {$_SESSION['cart.currency']['symbol_right']}" ?></td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                        <div class="col-md-6 account-left">
                            <form method="post" action="cart/checkout" role="form" data-toggle="validator">
                                <?php if(!isset($_SESSION['user'])): ?>
                                    ...
                                    <input type="telefon" name="telefon" class="form-control" id="telefon" placeholder="Телефон" data-error=" Телефон должен включать не менее 10 символов" data-minlength="10"
                                           value="<?=isset($_SESSION['form_data']['telefon']) ? h($_SESSION['form_data']['telefon']) : '';?>" required>
                                    <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                    <div class="help-block with-errors"></div>
                                    <div class="form-group has-feedback">
